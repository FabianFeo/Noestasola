...
class DatosPersonalConductora extends StatefulWidget {
  DatosPersonalConductora({Key key}) : super(key: key);

  @override
  _DatosPersonalConductoraState createState() => _DatosPersonalConductoraState();
}

class _DatosPersonalConductoraState extends State<DatosPersonalConductora> {
  User user = User();
  double height = 0;
  double width = 0;
  @override

import 'package:NoEstasSola/src/service/ConductoraCollectionService.dart';
import 'package:NoEstasSola/src/service/usersCollectionService.dart';
import 'package:NoEstasSola/src/view/DatosPersonal.dart';
import 'package:NoEstasSola/src/view/DatosPersonalConductora.dart';
...
class AuthServiceConductora {
  static final AuthServiceConductora _AuthServiceConductora =
      AuthServiceConductora._internal();
  factory AuthServiceConductora() {
    return _AuthServiceConductora;
  }
  ...
  void onAuthenticationSuccessful(BuildContext context, UserCredential value) {
    ConductoraCollectionService conductoraCollectionService =
        ConductoraCollectionService();
    conductoraCollectionService
        .getConductora(value.user.uid)
        .then((value) async {
      Navigator.of(context).pop();
      if (!value.exists) {
        Navigator.push(context,
            MaterialPageRoute(builder: (context) => DatosPersonalConductora()));
      } else {
